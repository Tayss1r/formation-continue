...
export default function VerificationsPage() {
  ...
  const handleAction = async (userId: number, action: ActionType) => {
    ...
    try {
      await apiClient.post(`/admin/verification/${userId}/${action}`);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Approuvez ou rejetez les demandes d&apos;inscription des entreprises et professeurs
          </p>
        </div>
        <button
                    ...
                    <div className="mt-2 space-y-1 text-sm text-muted-foreground">
                      ...
                      {user.role === "professor" && user.specialization && (
                        <div className="flex items-center gap-2">
                          ...
                          <span>Spécialisation: {user.specialization}</span>
                        </div>
                      )}
                      <div className="flex items-center gap-2">
          ...
          <div className="bg-card rounded-2xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-6 border-b border-border">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-foreground">Document de vérification</h2>
